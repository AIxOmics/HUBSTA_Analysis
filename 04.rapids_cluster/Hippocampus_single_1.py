...
adata.obsm['X_dmt_highdim'] = np.load("/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/X_dmt_highdim.npy")
adata.obsm['X_dmt'] = np.load("/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/X_dmt.npy")
...
with open('/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/colormap20250108_1.pkl', 'wb') as f:
    pickle.dump(colormap, f)

with open('/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/colormap20250108_1.pkl', 'rb') as f:
    colormap = pickle.load(f)

sc.pl.embedding(adata, basis = 'X_dmt', color = 'slice_code', show = False)
plt.savefig('/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/batch_20250108_1.png', dpi=300, bbox_inches='tight', pad_inches=0)
plt.close()


sc.pl.embedding(adata, basis = 'X_dmt', color = 'dmt_leiden',palette=colormap, show = False)
plt.savefig('/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/dmt_leiden_20250108_1.png', dpi=300, bbox_inches='tight', pad_inches=0)
plt.close()
...
plt.savefig('/data/work/05.cluster/FuseMap/0106/Hippocampus_latent_embeddings_all_single_pretrain/dmt_leiden_all_20250108_1.png', dpi = 450, bbox_inches = 'tight')
plt.close()
